...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_POST['text1']){
        ...
        $field = $_POST['data'];;
            ...
            $sql = "UPDATE `skilled_courses` SET ".$field." = '".$data."' WHERE `sno` = ".$sno."";
...
if (isset($_GET['delete'])) {
    ...
    $sql1 = "DELETE FROM `skilled_courses` WHERE `sno` = ".$sno."";
    // Execute SQL statement
	...
	<div class="wrapper">
		...
		<div class="container">
				...
				<table>
					...
					<tbody>
                    <?php
                    $sql1 = "SELECT * FROM skilled_courses ";
                    ...
                    if ($result1) {
                        if (mysqli_num_rows($result1) > 0) {
                            while ($row1 = mysqli_fetch_assoc($result1)) {
                                ...
                                <td><a href='#myModal?sno=".$row1['sno']."&text1=".$row1['sctype']."&data=sctype' class='no-hash' onclick='openModal(this.hash)'>".$row1['sctype']."</a></td>
                                <td><a href='#myModal?sno=".$row1['sno']."&text1=".$row1['screlation']."&data=screlation' class='no-hash' onclick='openModal(this.hash)'>".$row1['screlation']."</a></td>
