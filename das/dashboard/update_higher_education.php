...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_POST['text1']){
        ...
        $field = $_POST['data'];;
            ...
            $sql = "UPDATE `higher_ed` SET ".$field." = '".$data."' WHERE `sno` = ".$sno."";
...
if (isset($_GET['delete'])) {
    ...
    $sql1 = "DELETE FROM `higher_ed` WHERE `sno` = ".$sno."";
    // Execute SQL statement
                    ...
                    if ($result1) {
                        if (mysqli_num_rows($result1) > 0) {
                            while ($row1 = mysqli_fetch_assoc($result1)) {
                                ...
                                <td><a href='#myModal?sno=".$row1['sno']."&text1=".$row1['mbca']."&data=mbca' class='no-hash' onclick='openModal(this.hash)'>".$row1['mbca']."</a></td>
                                <td><a href='#myModal?sno=".$row1['sno']."&text1=".$row1['mbctype']."&data=mbctype' class='no-hash' onclick='openModal(this.hash)'>".$row1['mbctype']."</a></td>
