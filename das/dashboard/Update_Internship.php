...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_POST['text1']){
        ...
        $field = $_POST['data'];;
            ...
            $sql = "UPDATE `internship` SET ".$field." = '".$data."' WHERE `sno` = ".$sno."";
...
if (isset($_GET['delete'])) {
    ...
    $sql1 = "DELETE FROM `internship` WHERE `sno` = ".$sno."";
    // Execute SQL statement
                    ...
                    if ($result1) {
                        if (mysqli_num_rows($result1) > 0) {
                            while ($row1 = mysqli_fetch_assoc($result1)) {
                                ...
                                <td><a href='#myModal?sno=".$row1['sno']."&text1=".$row1['in_type']."&data=in_type' class='no-hash' onclick='openModal(this.hash)'>".$row1['in_type']."</a></td>
                                <td><a href='#myModal?sno=".$row1['sno']."&text1=".$row1['in_relation']."&data=in_relation' class='no-hash' onclick='openModal(this.hash)'>".$row1['in_relation']."</a></td>
