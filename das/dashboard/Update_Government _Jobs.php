...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_POST['text1']){
        ...
        $field = $_POST['data'];;
            ...
            $sql = "UPDATE `jobs` SET ".$field." = '".$data."' WHERE `sno` = ".$sno."";
...
if (isset($_GET['delete'])) {
    ...
    $sql1 = "DELETE FROM `jobs` WHERE `sno` = ".$sno."";
    // Execute SQL statement
                    ...
                    if ($result1) {
                        if (mysqli_num_rows($result1) > 0) {
                            while ($row1 = mysqli_fetch_assoc($result1)) {
                                echo  "<tr>
                                <td><a href='#myModal?sno=".$row1['sno']."&text1=".$row1['pg']."&data=pg' class='no-hash' onclick='openModal(this.hash)'>".$row1['pg']."</a></td>
                                <td><a href='#myModal?sno=".$row1['sno']."&text1=".$row1['ps']."&data=ps' class='no-hash' onclick='openModal(this.hash)'>".$row1['ps']."</a></td>
                                ...
                                <td><a href='#myModal?sno=".$row1['sno']."&text1=".$row1['banner']."&data=banner' class='no-hash' onclick='openModal(this.hash)'>".$row1['banner']."</a></td>
                                <td><a href='#myModal?sno=".$row1['sno']."&text1=".$row1['url']."&data=url' class='no-hash' onclick='openModal(this.hash)'>".$row1['url']."</a></td>
                                <td><a href='#myModal?sno=".$row1['sno']."&text1=".$row1['file_typ']."&data=file_typ' class='no-hash' onclick='openModal(this.hash)'>".$row1['file_typ']."</a></td>
